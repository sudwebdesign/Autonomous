 ...
 * 	"EMAIL_SMTP_USERNAME" => "xxxxxxxxxx@gmail.com",
 * 	"EMAIL_SMTP_PASSWORD" => "xxxxxxxxxxxxxxxxxxxx",
 * 	"EMAIL_SMTP_PORT", 465,
 ...
 */
	"EMAIL_PASSWORDRESET_URL" => "http://127.0.0.1/php-login-advanced/password_reset.php",
	"EMAIL_PASSWORDRESET_FROM" => "no-reply@example.com",
	"EMAIL_PASSWORDRESET_FROM_NAME" => "My Project",
 ...
 */
	"EMAIL_VERIFICATION_URL" => "http://127.0.0.1/php-login-advanced/register.php",
